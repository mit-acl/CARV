...
Saves: 
    alg10_mpc_w_custom_cost.gif
    alg10_mpc_w_custom_cost.mp4

Obstacles are in the form: [center_x, center_y, radius]

To call with a specific np seed, do /anim_alg10.py <seed_number>
...
gif_path = "alg10_mpc_w_custom_cost.gif"
mp4_path = "alg10_mpc_w_custom_cost.mp4"
