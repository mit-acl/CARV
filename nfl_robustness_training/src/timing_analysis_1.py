...
class TimingAnalyzer:
    ...
    def __init__(self, system_type='DoubleIntegrator', controller_name='constraint_default_more_data_5hz', num_trials=10):
...
def run_analysis(system_type='DoubleIntegrator', 
    ...
    # Create analyzer
    analyzer = TimingAnalyzer(system_type, controller_name, num_trials=num_trials)
