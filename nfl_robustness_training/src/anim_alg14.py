"""
Animation for alg14 — PSF with Forward MPC Buffer + Split-Terminal MPC.
...
but must end outside S (terminal constrained to S). Saves:
    alg14_psf_buffer.gif
    alg14_psf_buffer.mp4
...
from alg14_split_terminal import (
...
gif_path = "alg14_psf_buffer.gif"
mp4_path = "alg14_psf_buffer.mp4"
